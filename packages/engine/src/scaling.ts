...
export const ANALOG_PRESETS: AnalogPreset[] = [
  ...
  // ControlLogix isolated and specialty inputs — same p.31 table as the IF8,
  // different signal endpoints per module. Every one of these reaches 32767
  // past the nominal end of its range, and starts at −32768 rather than 0.
  {
    id: "clx-if6cis-int-0-20ma",
    label: "AB 1756-IF6CIS · integer, 0–20mA (−32768…32767 = 0…21.09376 mA)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IF6CIS (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
    source: "spec/vendor-analog-ranges.md",
    note: "Integer mode only. −32768 = 0 mA and 32767 = 21.09376 mA. Wider headroom than the IF8's 20.58 mA — do not reuse an IF8 conversion here.",
  },
  {
    id: "clx-if6i-int-pm10v",
    label: "AB 1756-IF6I · integer, ±10V (−32768…32767 = −10.54688…10.54688 V)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IF6I (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
    source: "spec/vendor-analog-ranges.md",
    note: "Integer mode only. Endpoints are ±10.54688 V, not ±10 V.",
  },
  {
    id: "clx-if6i-int-0-10v",
    label: "AB 1756-IF6I · integer, 0–10V (−32768…32767 = 0…10.54688 V)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IF6I (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
    source: "spec/vendor-analog-ranges.md",
    note: "Integer mode only. −32768 = 0 V and 32767 = 10.54688 V.",
  },
  {
    id: "clx-if6i-int-0-5v",
    label: "AB 1756-IF6I · integer, 0–5V (−32768…32767 = 0…5.27344 V)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IF6I (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
    source: "spec/vendor-analog-ranges.md",
    note: "Integer mode only. −32768 = 0 V and 32767 = 5.27344 V.",
  },
  {
    id: "clx-if6i-int-0-20ma",
    label: "AB 1756-IF6I · integer, 0–20mA (−32768…32767 = 0…21.09376 mA)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IF6I (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
    source: "spec/vendor-analog-ranges.md",
    note: "Integer mode only. −32768 = 0 mA and 32767 = 21.09376 mA.",
  },
  {
    id: "clx-ir6i-int-1-487",
    label: "AB 1756-IR6I · integer, 1–487Ω (−32768…32767 = 0.859068653…507.862 Ω)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IR6I (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
    source: "spec/vendor-analog-ranges.md",
    note: "RTD module, resistance in ohms. Integer mode only. The low endpoint is 0.859068653 Ω, not 1 Ω.",
  },
  {
    id: "clx-ir6i-int-2-1000",
    label: "AB 1756-IR6I · integer, 2–1000Ω (−32768…32767 = 2…1016.502 Ω)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IR6I (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
    source: "spec/vendor-analog-ranges.md",
    note: "RTD module, resistance in ohms. Integer mode only.",
  },
  {
    id: "clx-ir6i-int-4-2000",
    label: "AB 1756-IR6I · integer, 4–2000Ω (−32768…32767 = 4…2033.780 Ω)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IR6I (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
  ...
  {
    id: "clx-ir6i-int-8-4020",
    label: "AB 1756-IR6I · integer, 8–4020Ω (−32768…32767 = 8…4068.392 Ω)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IR6I (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
  ...
  {
    id: "clx-it6i-int-12-30mv",
    label: "AB 1756-IT6I · integer, −12…30mV (−32768…32767 = −15.80323…31.396 mV)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IT6I / -IT6I2 (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
    source: "spec/vendor-analog-ranges.md",
    note: "Thermocouple module, millivolts at the terminals — not temperature. Integer mode only; endpoints are −15.80323 and 31.396 mV.",
  },
  {
    id: "clx-it6i-int-12-78mv",
    label: "AB 1756-IT6I · integer, −12…78mV (−32768…32767 = −15.15836…79.241 mV)",
    vendor: "Allen-Bradley",
    module: "ControlLogix 1756-IT6I / -IT6I2 (integer mode)",
    rawMin: -32768,
    rawMax: 32767,
    source: "spec/vendor-analog-ranges.md",
    note: "Thermocouple module, millivolts at the terminals — not temperature. Integer mode only; endpoints are −15.15836 and 79.241 mV.",
  },
