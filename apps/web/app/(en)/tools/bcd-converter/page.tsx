...
export const metadata: Metadata = {
  ...
  openGraph: { title: "BCD Converter — packed BCD ↔ decimal with validation", description: "Free online BCD converter: packed BCD words to decimal and back, with per-nibble validation that pinpoints invalid digits. 100% in your browser.", type: "website" },
};
