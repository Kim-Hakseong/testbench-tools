...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Modbus Address Converter — 40001 ↔ 0-based ↔ 1-based", description: "Convert between 4xxxx data-model notation, 1-based and 0-based Modbus protocol addresses.", type: "website" },
};
