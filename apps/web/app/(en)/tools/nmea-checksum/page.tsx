...
export const metadata: Metadata = {
  ...
  openGraph: { title: "NMEA Checksum Calculator — validate & generate 0183 sentences", description: "Validate an NMEA 0183 sentence's checksum or generate the complete $…*HH sentence.", type: "website" },
};
