...
export const metadata: Metadata = {
  ...
  openGraph: { title: "CAN Bit Timing Calculator — prescaler, segments, sample point", description: "Prescaler, SEG1/SEG2 and sample point candidates for your CAN clock and bitrate.", type: "website" },
};
