...
export const TOOLS: ToolMeta[] = [
  ...
  { slug: "two-point-calibration", name: "2-Point Calibration Calculator", description: "Derive slope and offset from two measured reference points.", category: "plc-industrial", p0: false, locale: "en", status: "soon", tags: ["calibration", "slope", "offset"] },
  { slug: "signal-converter", name: "Signal Converter", description: "Convert between mA, V and psi process signal ranges.", category: "plc-industrial", p0: false, locale: "en", status: "soon", tags: ["ma", "voltage", "psi", "signal"] },
  ...
  { slug: "loop-burden", name: "Loop Burden Calculator", description: "Check 4-20mA loop voltage budget against device burdens.", category: "plc-industrial", p0: false, locale: "en", status: "soon", tags: ["loop", "burden", "4-20ma", "voltage"] },
  { slug: "modbus-address-converter", name: "Modbus Address Converter", description: "Translate 0-based, 1-based and 4xxxx Modbus register notations.", category: "plc-industrial", p0: false, locale: "en", status: "soon", tags: ["modbus", "address", "register", "40001"] },
  ...
  { slug: "voltage-divider", name: "Voltage Divider Calculator", description: "Solve divider ratios with nearest E24/E96 resistor values.", category: "sensor-signal", p0: false, locale: "en", status: "soon", tags: ["voltage divider", "resistor", "e24", "e96"] },
  { slug: "rms-peak", name: "RMS ↔ Peak Converter", description: "Convert RMS, peak and peak-to-peak for sine waveforms.", category: "sensor-signal", p0: false, locale: "en", status: "soon", tags: ["rms", "peak", "sine", "amplitude"] },
  { slug: "db-dbm", name: "dB · dBm Calculator", description: "Convert power ratios, dB, dBm and voltage levels.", category: "sensor-signal", p0: false, locale: "en", status: "soon", tags: ["db", "dbm", "power", "ratio"] },
