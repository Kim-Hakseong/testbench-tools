...
export const HUB: Record<SiteLocale, HubStrings> = {
  en: {
    ...
    subtitle:
      "47 free tools for test & measurement, embedded and industrial engineers — CRC, Modbus frames, PLC scaling, sensor math, file converters. No sign-up, nothing leaves your browser.",
    searchPlaceholder: "Search 47 tools — try “crc”, “modbus”, “pt100”…",
    popular: "Popular:",
    stats: "100% free · 47 tools · 8 categories · in-browser",
  ...
  ko: {
    ...
    subtitle:
      "계측·임베디드·산업자동화 엔지니어용 무료 툴 47종 — CRC, Modbus 프레임, PLC 스케일링, 센서 계산, 파일 변환. 가입 없이, 데이터는 브라우저 밖으로 나가지 않습니다.",
    searchPlaceholder: "47개 툴 검색 — “crc”, “modbus”, “pt100”…",
    popular: "인기:",
    stats: "100% 무료 · 툴 47종 · 8개 카테고리 · 브라우저 내 계산",
  ...
  ja: {
    ...
    subtitle:
      "計測・組み込み・産業オートメーションエンジニアのための無料ツール47種 — CRC、Modbusフレーム、PLCスケーリング、センサー計算、ファイル変換。登録不要、データはブラウザの外に出ません。",
    searchPlaceholder: "47個のツールを検索 — 「crc」「modbus」「pt100」…",
    popular: "人気:",
    stats: "100%無料 · ツール47種 · 8カテゴリ · ブラウザ内",
  ...
  de: {
    ...
    subtitle:
      "47 kostenlose Tools für Mess-, Embedded- und Automatisierungstechnik — CRC, Modbus-Frames, SPS-Skalierung, Sensor-Mathematik, Dateikonverter. Ohne Anmeldung, nichts verlässt Ihren Browser.",
    searchPlaceholder: "47 Tools durchsuchen — z. B. „crc“, „modbus“, „pt100“ …",
    popular: "Beliebt:",
    stats: "100 % kostenlos · 47 Tools · 8 Kategorien · im Browser",
  ...
  zh: {
    ...
    title: "工程计算，一个标签页搞定",
    subtitle:
      "面向测试测量、嵌入式与工业自动化工程师的 47 个免费工具 — CRC、Modbus 报文、PLC 换算、传感器计算、文件转换。无需注册，数据不离开浏览器。",
    searchPlaceholder: "搜索 47 个工具 — 试试 “crc”、“modbus”、“pt100”…",
    popular: "热门:",
    stats: "100% 免费 · 47 个工具 · 8 个分类 · 浏览器本地",
    noMatch: "没有匹配的工具:",
    soon: "即将上线",
    enChip: "EN",
    appsTitle: "桌面应用",
