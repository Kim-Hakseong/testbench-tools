...
export const HUB: Record<SiteLocale, HubStrings> = {
  en: {
    ...
    subtitle:
      "54 free tools for test & measurement, embedded and industrial engineers — CRC, Modbus frames, PLC scaling, sensor math, file converters. No sign-up, nothing leaves your browser.",
    searchPlaceholder: "Search 54 tools — try “crc”, “modbus”, “pt100”…",
    popular: "Popular:",
    stats: "100% free · 54 tools · 8 categories · in-browser",
  ...
  ko: {
    ...
    subtitle:
      "계측·임베디드·산업자동화 엔지니어용 무료 툴 54종 — CRC, Modbus 프레임, PLC 스케일링, 센서 계산, 파일 변환. 가입 없이, 데이터는 브라우저 밖으로 나가지 않습니다.",
    searchPlaceholder: "54개 툴 검색 — “crc”, “modbus”, “pt100”…",
    popular: "인기:",
    stats: "100% 무료 · 툴 54종 · 8개 카테고리 · 브라우저 내 계산",
  ...
  ja: {
    ...
    subtitle:
      "計測・組み込み・産業オートメーションエンジニアのための無料ツール54種 — CRC、Modbusフレーム、PLCスケーリング、センサー計算、ファイル変換。登録不要、データはブラウザの外に出ません。",
    searchPlaceholder: "54個のツールを検索 — 「crc」「modbus」「pt100」…",
    popular: "人気:",
    stats: "100%無料 · ツール54種 · 8カテゴリ · ブラウザ内",
  ...
  de: {
    ...
    subtitle:
      "54 kostenlose Tools für Mess-, Embedded- und Automatisierungstechnik — CRC, Modbus-Frames, SPS-Skalierung, Sensor-Mathematik, Dateikonverter. Ohne Anmeldung, nichts verlässt Ihren Browser.",
    searchPlaceholder: "54 Tools durchsuchen — z. B. „crc“, „modbus“, „pt100“ …",
    popular: "Beliebt:",
    stats: "100 % kostenlos · 54 Tools · 8 Kategorien · im Browser",
